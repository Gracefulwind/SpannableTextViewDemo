...
public class MessageListItemView extends RelativeLayout {
    ...
    private void loadViews() {
        ...
        setLayoutParams(new AbsListView.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, fiftyDPInPixels));
//        setBackgroundResource(R.drawable.message_list_item_background);
        setBackgroundResource(R.color.message_list_item_background_unread1);
